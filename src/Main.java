...
// Cole Beck
// This project is an attempt at a Daily Optimizer, a program used to help me plan out my
// day while utilizing my time at maximum efficiency
// Operator precedence refers to how operators are parsed compared to each other.
// Higher precedence operators are executed before its counterparts.
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    // its benefits include: one superclass can be used for all subclasses, all
    // changes can
    // be done in one place, avoids duplicate code, reduces complexity
 ...
 * memory in large arrays, where the memory savings actually matters. They can also be used in place
